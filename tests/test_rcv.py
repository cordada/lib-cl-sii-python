...
class ProcessRcvCsvFileTests(TestCase):
    ...
    def test_ok(self) -> None:
        ...
        file_csv = open('tests/test_data/rcv_csv/purchase_all_document_types.csv', mode='r')
        # TODO: fix type
        rows_generator = rcv.process_rcv_csv_file(  # type: ignore
            file_csv,
            self.owner_rut.canonical)
    ...
    def test_invalid_row(self) -> None:
        file_csv = open('tests/test_data/rcv_csv/purchase_invalid_row.csv', mode='r')
        # TODO: fix type
        rows_generator = rcv.process_rcv_csv_file(  # type: ignore
            file_csv,
            self.owner_rut.canonical)
    ...
    def test_missing_row(self) -> None:
        file_csv = open('tests/test_data/rcv_csv/purchase_missing_row.csv', mode='r')
        # TODO: fix type
        rows_generator = rcv.process_rcv_csv_file(  # type: ignore
            file_csv,
            self.owner_rut.canonical)
    ...
    def test_invalid_csv(self) -> None:
        file_csv = open('tests/test_data/rcv_csv/invalid.csv', mode='r')
        # TODO: fix type
        rows_generator = rcv.process_rcv_csv_file(  # type: ignore
            file_csv,
            self.owner_rut.canonical)
